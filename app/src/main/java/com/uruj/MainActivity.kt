...
private sealed interface AppScreen {
    ...
    // v0.9.66 — per-stage RMSSD trend (deep/REM/light over time) from
    // HrvSnapshotRepository per-stage fields (since v0.9.48).
    data object PerStageRmssdTrend : AppScreen
                ...
                when {
                    ...
                    completed != null -> RideSummaryScreen(
                        ...
                        AppScreen.BioLab -> BioLabScreen(
                            ...
                            onOpenPerStageRmssdTrend = { screen = AppScreen.PerStageRmssdTrend },
                        ...
                        // v0.9.28 — frequency-domain HRV trend screens
                        AppScreen.LfHfTrend -> com.uruj.ui.trend.LfHfTrendScreen(
                            onBack = { screen = AppScreen.BioLab },
                        )
                        AppScreen.DfaAlpha1Trend -> com.uruj.ui.trend.DfaAlpha1TrendScreen(
                            onBack = { screen = AppScreen.BioLab },
                        )
                        // v0.9.66 — per-stage RMSSD trend (deep/REM/light)
                        AppScreen.PerStageRmssdTrend -> com.uruj.ui.trend.PerStageRmssdTrendScreen(
                            onBack = { screen = AppScreen.BioLab },
                        )
